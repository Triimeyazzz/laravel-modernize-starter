...
<template>
                        ...
                        <div class="pa-4 pb-0 pr-0">
                            ...
                            <div class="pa-5 pl-0">
                                <div class="d-flex align-center justify-space-between">
                                    <Link :href="route('home')" class="text-decoration-none d-flex align-center">
    ...
    <Link href="/" class="text-decoration-none">
        <v-btn variant="text" color="primary">Link 1</v-btn>
    </Link>
    <Link href="/" class="text-decoration-none">
        <v-btn variant="text" color="primary">Link 2</v-btn>
    </Link>
    <Link href="/" class="text-decoration-none">
        <v-btn variant="text" color="primary">Link 3</v-btn>
    </Link>
</template>
